...
<%@ page import="co.edu.unac.ing.store.dto.User" %>
<!DOCTYPE html>
<html lang="en">
    ...
    <ul class="nav navbar-right top-nav">
      <li class="dropdown">
        <i href="#"   class="dropdown-toggle" data-toggle="dropdown" >
          <a href="" style="color: white;"><i class="fa fa-user" > <%=user.getName()%> </i> <b class="caret"></b></a>
        </i>
        ...
        <ul class="dropdown-menu">
          ...
          <%if(user.getType().equals("0")){%>
            <li style="text-align: center;">Administrador</li>
            <li>
              <a href="RegistroProductos"><i class="fa fa-fw fa-user"></i>Registrar Producto</a>
            </li>
          <%}%>
            <li>
