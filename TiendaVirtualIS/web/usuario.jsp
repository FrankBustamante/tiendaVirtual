...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="static/backend/css/font-awesome/font-awesome.min.css" rel="stylesheet" type="text/css">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form role="form" method="post" action="/usuarios">
                        ...
                        <div class="form-group">
                            ...
                            <p class="form-control-static">Numero Celular o Fijo</p>
                        </div>

                        <div class="form-group">
                            <label>Correo Electronico</label>
                            <input name="email" class="form-control"  placeholder="correo@ejemplo.com" >
                        </div>

                        <div class="form-group" >
                            <label ><b>Direccion</b></label>
                            <input name="ciudad" class="form-control"  placeholder="departamento y ciudad">
                        ...
                        <div class="form-group" >
                            ...
                            <input name="contra" class="form-control"  type="password" placeholder="contraseña">
                            <p class="help-block">minimo 6 caracteres sin espacios</p>
                        </div>

                        <input type="hidden" name="ip" id="ip" >

                        <button type="submit" class="btn btn-default">Completar</button>
